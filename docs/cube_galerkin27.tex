...
The body form is even simpler since no integration by parts is needed.
\qed
\end{proof}
...
\item Compare to the Path-A values produced by
      \texttt{compute\_cube\_tmatrix} in
      \texttt{cubic\_scattering/effective\_contrasts.py}.
\end{enumerate}
